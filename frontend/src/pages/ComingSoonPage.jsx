...
const ComingSoonPage = () => {
  ...
  return (
    ...
    <img src={gemini} alt="Gemini" />
      ...
      <h1 className="heading text-5xl  text-white leading-normal font-normal "><span className=' pl-20 text-6xl max-xsm:pl-14 font-bold text-[#AE8DFF] max-xsm:text-4xl'>Hey👋 <br className='res' /></span> am <span className='text-7xl font-bold sifragradient max-xsm:text-4xl big '>Sifra</span>, <br className='res1 ' /><span className='max-xsm:pl-9'>your personal </span> <span className='text-7xl font-bold aibuddygrad max-xsm:text-4xl big '>AI Buddy</span> <br className='res' /> <br className='res1' /><span className='text-4xl  cominggrad  max-xsm:ml-5 max-xsm:text-2xl max-xsm:text-center max-xsm:mx-auto max-xsm:pl-12 '>coming soon<span className='com'>................</span></span></h1>
      <h2 className=' max-xsm:text-center max-xsm:px-12 max-xsm:pt-28 pl-20  mt-9 text-3xl max-xsm:text-xl text-white heading '>About<span className='text-5xl font-bold  sifragradient max-xsm:text-4xl'> Sifra</span></h2>
